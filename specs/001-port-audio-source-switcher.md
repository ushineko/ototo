...
- [ ] R10: the sections, with headless tests naming the defect each prevents. R10.1 in part (PR: feat/tray-and-tick): the list with Switch to, Connect and Disconnect on the selected row and the auto-switch check; reordering, volume and mute remain.
